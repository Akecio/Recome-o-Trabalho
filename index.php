...
<main>
      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start cor">
            ...
            <h4>Deixe sugestões e registre-se no nosso site</h4>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption cor">
            <h1>Crateús - CE</h1>
            <h4>Umas das 10 melhores escolas do Ceará</h4>
      ...
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption text-end cor">
            <h1>Faça seu BO</h1>
            <h4>Criamos uma página para registração do BO</h4>
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">Nos <span class="text-muted">ajude</span></h2>
        <br><br>
